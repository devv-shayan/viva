...
export async function VivaExperience({ role, vivaId }: { role: "teacher" | "student"; vivaId?: string }) {
  ...
  return <VivaFlow examinerInstructions={extractExaminerInstructions(examinerAgent)} role={role} sampleEssay={extractSampleEssay(fixture)} vivaId={vivaId} />;
}